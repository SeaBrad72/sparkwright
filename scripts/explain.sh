...
# What it changes: Read-only — prints gate rationale from docs/why-gates.md; mutates nothing.
# Guardrails: Adds no enforcement; advisory and mode-blind (never reads the process mode); the doc is the single source of truth.
set -eu
here=$(dirname "$0")

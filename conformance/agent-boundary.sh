...
.github/workflows/ci.yml" 1 "workflow change, ratified -> PASS"
  ...
  for _a in '--gate governance' 'meta-control artifact' 'docs/enterprise/meta-control.md' 'governance file set' 'retired workaround'; do

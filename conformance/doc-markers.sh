...
DM_EXPECT='artifact-lineage:6 gate-eval-secrets:5 feedback-link-lifecycle:3 validation-terminal-state:8 dod-precedence:1 collected-not-gated:3 adopter-claims-honest:3'

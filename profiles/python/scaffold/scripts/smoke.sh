...
#
# Usage:  BASE_URL=http://localhost:8000 sh scripts/smoke.sh   (BASE_URL defaults to :8000)
...
#    Strict 'true' parse mirrors src/app/flags.py: only the exact string "true" expects the new greeting.

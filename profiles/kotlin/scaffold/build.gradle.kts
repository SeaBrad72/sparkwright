...
// gate-dep-scan: make the OWASP dependency-check actually gate. Without this block
// failBuildOnCVSS keeps its plugin default of 11.0 (no CVSS can exceed 10, so the build
// never fails). 7.0 fails the build on any HIGH/CRITICAL finding.
dependencyCheck {

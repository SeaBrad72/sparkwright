...
- **Tier 1 — Honesty (cheap, high trust-ROI) — STARTED.** Fix + **lock** the file count (F1); README maturity-disclosure shipped to adopters (F3); surface the never-adopted caveat in *exported* docs (F3); down-grade over-claimed "PROVEN" verbs to single-reference reality (F4).

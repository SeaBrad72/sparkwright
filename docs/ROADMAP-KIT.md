...
- **H3c — Long-session drift self-check (NEXT)** — a periodic mid-session re-check against the active plan/standards (a practice/helper, not mechanical). Consider folding into P3's `sparkwright doctor`.

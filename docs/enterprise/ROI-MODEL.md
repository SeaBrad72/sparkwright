...
> **Pre-adoption model — not a measured result.** This worksheet was written ahead of real adoption:
> every figure in it is arithmetic over *your* inputs, not a benchmark and not a guarantee. As real
> rollouts supply measured baselines, the illustrative examples here are replaced with measured ones.

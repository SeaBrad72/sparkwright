...
1. **Read the delta.** Review the release notes (your `CHANGELOG.md`, or the upstream project's GitHub Releases) from the pinned version to the target — what changed, and especially whether any *required gate* was added (a **MAJOR** bump).

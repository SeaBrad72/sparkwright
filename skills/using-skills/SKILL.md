...
<!-- The frontmatter, the discipline phrases, and the index paths below are conformance-load-bearing:
     ...
     skills/operating, skills/build, skills/demonstrate). Edits that drop or rename them can turn the skill-spine lock RED. -->
...
## The index — the kit's spine skills
...
| demonstrate | `skills/demonstrate` | Surface a working increment for human taste/judgment before a Go/No-Go (produce the observable, frame the specific judgment call, record the verdict in a UAT sign-off). |
